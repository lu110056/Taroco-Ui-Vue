  ...
  <div class="app-container pull-auto">
    <avue-crud ref="crud"
      ...
      <template slot="menuRight">
        <el-button type="primary" @click="handleAdd" v-if="permissions.sys_route_add" icon="el-icon-plus">新 增</el-button>
        <el-button type="info" @click="handleApply" v-if="permissions.sys_route_add" icon="el-icon-upload">同 步</el-button>
      </template>
